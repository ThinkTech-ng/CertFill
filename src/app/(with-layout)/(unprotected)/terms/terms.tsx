...
const TermsAndConditions = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6">Terms and Conditions for Certfill</h1>
      ...
      <p className="mb-4">
        &quot;Certfill&quot; refers to our platform and services. &quot;User&quot; refers to any
        individual or organization using Certfill. &quot;Content&quot; refers to all data,
        documents, and materials uploaded to the platform.
      </p>
      ...
      <p className="mb-4">
        Certfill grants you a non-exclusive, non-transferable license to use the platform for lawful
        purposes. You agree not to misuse the platform or engage in activities that violate laws or
        harm others.
      </p>
      ...
      <ul className="list-disc ml-5 mb-4">
        ...
        <li>
          You agree not to upload harmful, illegal, or copyrighted content without permission.
        </li>
      </ul>
      ...
      <p className="mb-4">
        Certfill values your privacy and processes data in accordance with our Privacy Policy. We
        comply with the Nigeria Data Protection Regulation (NDPR).
      </p>
      ...
      <p className="mb-4">
        Certfill owns all rights to the platform, including trademarks and content. Users retain
        ownership of their uploaded content but grant Certfill a license to use it for service
        delivery.
      </p>
      ...
      <p className="mb-4">
        Certfill is provided &quot;as is&quot; without warranties. We are not liable for losses due
        to user errors, unauthorized access, or interruptions in service.
      </p>
      ...
      <p className="mb-4">
        Certfill reserves the right to suspend or terminate access if users violate these terms.
        Users may discontinue using the service at any time.
      </p>
      ...
      <p className="mb-4">
        Certfill may update these terms from time to time. Continued use of the platform constitutes
