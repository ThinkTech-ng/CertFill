    ...
    <>
      <div className="text-center flex flex-col gap-5 justify-center items-center pt-10 px-5">
        <svg width="150" height="150" viewBox="0 0 150 150" fill="none">
          <path
            d="M43.75 50L62.1376 60.8714C72.8575 67.2094 77.1425 67.2094 87.8625 60.8714L106.25 50"
            stroke="black"
            strokeWidth="3"
          ...
          />
          <path
            d="M115.625 87.5L117.237 91.8562C119.351 97.5687 120.408 100.425 122.491 102.509C124.575 104.592 127.431 105.649 133.144 107.763L137.5 109.375L133.144 110.987C127.431 113.101 124.575 114.158 122.491 116.241C120.408 118.325 119.351 121.181 117.237 126.894L115.625 131.25L114.013 126.894C111.899 121.181 110.842 118.325 108.759 116.241C106.675 114.158 103.819 113.101 98.1062 110.987L93.75 109.375L98.1062 107.763C103.819 105.649 106.675 104.592 108.759 102.509C110.842 100.425 111.899 97.5687 114.013 91.8562L115.625 87.5Z"
            fill="#00A2B9"
          />
        </svg>

        <h3 className="text-3xl font-bold  text-primary">Account verified</h3>
