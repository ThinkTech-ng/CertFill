'use client';
import DynamicForm, { DynamicArrayForm } from '@/components/organism/forms/dynamic';
                    ...
                    {paymentPlan.map((plan) => (
                      ...
                      >
                        <div className="flex-1">
                          <span className="text-lg text-black block">{plan.label}</span>
                          <span className="text-jumbo text-sm">{plan.description}</span>
                        </div>
                    ...
                    {array.fields.map((field, index) => (
                      <div className="flex items-center gap-2  my-2.5 relative" key={index}>
                        <Input
                          ...
                          onChange={(e) =>
                            form.setValue(`${'courses'}.${index}.name`, e.target.value, {
                              shouldValidate: true,
                            })
                          }
                        />
