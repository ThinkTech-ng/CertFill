    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <ul className="list-disc ml-5 mb-4">
        <li>
          ...
          details required for certificate generation.
        </li>
        <li>
          Document Information: Data you input to create and download
          certificates.
        </li>
        <li>
          Usage Data: Information on how you interact with our platform to help
      ...
      <ul className="list-disc ml-5 mb-4">
        ...
        <li>
          Secure Servers: We use secure servers and firewalls to prevent
          unauthorized access.
        </li>
        <li>
          Access Control: Only authorized personnel have access to your
          information.
        </li>
      </ul>
      ...
      <p className="mb-4">
        ...
        this policy or as required by law. You may request the deletion of your
        data at any time.
      </p>
      ...
      <p className="mb-4">
        Certfill complies with the Nigeria Data Protection Regulation (NDPR) and
        other applicable laws to ensure the highest standards of data privacy
        and security.
      </p>
