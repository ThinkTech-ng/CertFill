    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="w-[1240px] max-w-[90%] h-[700px] max-h-[90%] bg-white flex flex-row justify-center gap-10 px-6 items-center ">
        <div className="flex flex-col gap-3">
          ...
          <div></div>
          <button type="button" onClick={handleSave} className="saveButton h-[56px] max-w-[388px]">
            Save and Exit
          </button>
        </div>
        ...
        <div className="overflow-hidden h-[373px] w-[527px] relative pdf-container">
          <iframe
            ...
            title="PDF Preview"
          ></iframe>
          {!box && <div onClick={handleAddBox} className="absolute inset-0 bg-transparent"></div>}
