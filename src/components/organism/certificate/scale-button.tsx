const ScaleButton = ({ onClick, type, backgroundColor = '#D0F9FF' }: any) => {
  ...
  return (
    <span 
        onClick={onClick}
        className={`bg-[${backgroundColor}] text-white w-8 h-8 rounded-full flex items-center justify-center shadow-md`}
    >
        {scaleIcon()}
    </span>
  )
